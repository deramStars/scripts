...
[task_local]
#东东小窝
16 0 * * * jd_small_home.js, tag=东东小窝, img-url=https://raw.githubusercontent.com/58xinian/icon/master/ddxw.png, enabled=true
...
function updateInviteCode(url = 'http://193.112.28.110/inviteCode/jd_updateSmallHomeInviteCode.json') {
  return new Promise(resolve => {
    $.get({url,headers:{
